# Crystal Reports Schulungsunterlagen

Dies sind die Schulungsunterlagen für Crystal Reports. Die Dokumentation ist Open Source und wir haben sie mit [MkDocs](https://www.mkdocs.org) und [Material for MkDocs](https://squidfunk.github.io/mkdocs-material) realisiert. 
...
1. Erstelle einen lokalen Ordner für die Dokumentation, z.B. `c:\docs\crystal-schulungen`.

2. Starte die Eingabeaufforderung und wechsle in den Ordner `c:\docs\crystal-schulungen`.

3. Tippe den Befehl `git clone https://github.com/stuebersystems/doc.crystal-schulungen.de.git` ein, um das Repository zu klonen.
...
1. Öffne die URL `https://github.com/stuebersystems/doc.crystal-schulungen.de` in deinem Webbrowser

2. Klicke auf die Schaltfläche `Clone or download` und dann auf `Download ZIP`.

3. Entpacke das Zip-Archiv in einen lokalen Ordner Deiner Wahl, z.B. `c:\docs\crystal-schulungen`.
...
1. Starte die Eingabeaufforderung und wechsle in den Ordner `c:\docs\crystal-schulungen`.
